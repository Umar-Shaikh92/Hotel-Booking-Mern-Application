...
//       console.log("Sending to API:", newhotel);

//       await axios.post("/api/hotels", newhotel);
//     } catch (err) {
//       console.log("Error submitting hotel:", err);
//     }
//   };
...
//                 files
//                   ? URL.createObjectURL(files[0])
//                   : "https://media.istockphoto.com/id/1226328537/vector/image-place-holder-with-a-gray-camera-icon.jpg"
//               }
//               alt="Hotel"
//             />
//           </div>
